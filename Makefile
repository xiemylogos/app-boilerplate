...
ifeq ($(TARGET_NAME),TARGET_NANOS)
    ICONNAME=icons/nanos_app_ont.gif
else ifeq ($(TARGET_NAME),TARGET_STAX)
    ICONNAME=icons/stax_app_ont.gif
else ifeq ($(TARGET_NAME),TARGET_FLEX)
    ICONNAME=icons/flex_app_ont.gif
else
    ICONNAME=icons/nanox_app_ont.gif
endif
